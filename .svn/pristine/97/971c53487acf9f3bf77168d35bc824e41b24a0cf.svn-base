...
public class WorkVO extends ComDefaultVO implements Serializable{
	...
	private String orgNm;			// 기관 코드명 
	private String orgLc;			// 기관 대분류
	private String orgMc;			// 기관 중분류
	private String orgSc;			// 기관 소분류
	
	private int taskId;				// 업무ID
	private String taskIdx;			// 업무구분
	private String taskNm;			// 업무명
	private String taskContents;	// 업무내용
	private String urgent;			// 긴급공지
	private String closeDt;			// 마감일
	private String closeTm;			// 마감시간
	private String manager;			// 담당자
	private String atchFileId;      // 첨부파일	
	private String step;			// 진행단계
	
	private int itemId;				// 항목번호
	private String itemNm;			// 항목명
//	private String taskId;			
	private String itemDetail;		// 항목상세
	private String inputYn;			// 입력가능
	private String textYn;			// 문자입력가능
	
	private String orgName;			// 기관명
	private String useYn;			// 사용여부
	
	private String startDt;			// 마감 기간 조회 시작일 설정 
	private String endDt;			// 마감 기간 조회 최종일 설정
	...
	/* 공통코드 : 진행상태(STE) */
	private String steCd;			// 진행상태 코드
	private String steNm;			// 진행상태명
	
	/* 공통코드 : 업무구분(TAS) */
	private String tasCd;			// 업무구분 코드	
	private String tasNm;			// 업무구분명
	
	/* 공통코드 : 승인상태(REQ) */
	private String reqCd;			// 승인상태 코드	
	private String reqNm;			// 승인상태명
	
	private String myOrgId;			// 로그인한 기관명
	private String approval;		// 승인상태
	private String itemValue;		// 복지기관에서 항목에 대해 저장하는 값
	...
	public String getOrgLc() {
		return orgLc;
	}
	public void setOrgLc(String orgLc) {
		this.orgLc = orgLc;
	}
	...
	public String getTasCd() {
		return tasCd;
	}
	public void setTasCd(String tasCd) {
		this.tasCd = tasCd;
	}
